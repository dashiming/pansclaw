...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    modelSetup: "Configure modelo padrão e chaves de API rapidamente.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando pansclaw dashboard --no-open no desktop.",
    },
    insecure: {
