...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    modelSetup: "Standardmodell und API-Schlüssel schnell konfigurieren.",
    ...
    config: "~/.openclaw-pansclaw/pansclaw.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von pansclaw dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
