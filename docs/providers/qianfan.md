---
summary: "Use Qianfan's unified API to access many models in PansClaw"
read_when:
...
3. PansClaw installed on your system
...
4. Copy the API key for use with PansClaw
...
- [PansClaw Configuration](/gateway/configuration)
