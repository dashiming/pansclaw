---
summary: "Use Venice AI privacy-focused models in PansClaw"
read_when:
  - You want privacy-focused inference in PansClaw
...
After setup, PansClaw shows all available Venice models. Pick based on your needs:
...
PansClaw automatically discovers models from the Venice API when `VENICE_API_KEY` is set. If the API is unreachable, it falls back to a static catalog.
