---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with PansClaw"
read_when:
  - You want Xiaomi MiMo models in PansClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). PansClaw uses
