---
summary: "Use Qwen OAuth (free tier) in PansClaw"
read_when:
  - You want to use Qwen with PansClaw
...
If you already logged in with the Qwen Code CLI, PansClaw will sync credentials
