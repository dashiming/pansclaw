---
summary: "Use OpenCode Zen and Go catalogs with PansClaw"
read_when:
...
OpenCode exposes two hosted catalogs in PansClaw:

- `opencode/...` for the **Zen** catalog
- `opencode-go/...` for the **Go** catalog

Both catalogs use the same OpenCode API key. PansClaw keeps the runtime provider ids
