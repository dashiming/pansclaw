...
You can point PansClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or PansClaw
...
- [Anthropic provider](/providers/anthropic) - Native PansClaw integration with Claude setup-token or API keys
