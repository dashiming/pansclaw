---
summary: "Use Mistral models and Voxtral transcription with PansClaw"
read_when:
  - You want to use Mistral models in PansClaw
...
PansClaw supports Mistral for both text/image model routing (`mistral/...`) and
