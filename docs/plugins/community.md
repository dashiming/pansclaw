...
read_when:
  - You want to publish a third-party PansClaw plugin
...
This page tracks high-quality **community-maintained plugins** for PansClaw.
...
- **WeChat** — Connect PansClaw to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
