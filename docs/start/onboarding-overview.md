---
summary: "Overview of PansClaw onboarding options and flows"
read_when:
...
PansClaw supports multiple onboarding paths depending on where the Gateway runs
...
Use the PansClaw app when you want a fully guided setup on macOS. Docs:
