---
summary: "Backstory and lore of PansClaw for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "PansClaw Lore"
---

# The Lore of PansClaw 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **PansClaw**.
...
In the end, **PansClaw** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
The **Moltiverse** is the community and ecosystem around PansClaw. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then PansClaw): _happily runs `find ~` and shares entire directory structure in group chat_
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at PansClaw" to promote pump-and-dump tokens.
...
**The Great PansClaw Migration** began.
