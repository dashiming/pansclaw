---
summary: "First-run onboarding flow for PansClaw (macOS app)"
read_when:
...
- By default, PansClaw is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give PansClaw">
