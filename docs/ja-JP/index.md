---
read_when:
  - 新規ユーザーにPansClawを紹介するとき
summary: PansClawは、あらゆるOSで動作するAIエージェント向けのマルチチャネルgatewayです。
title: PansClaw
x-i18n:
...
<Columns>
  <Card title="はじめに" href="/start/getting-started" icon="rocket">
    PansClawをインストールし、数分でGatewayを起動できます。
  </Card>
...
PansClawは、単一のGatewayプロセスを通じてチャットアプリをPiのようなコーディングエージェントに接続します。PansClawアシスタントを駆動し、ローカルまたはリモートのセットアップをサポートします。
...
- **何もしなければ**、PansClawはバンドルされたPiバイナリをRPCモードで使用し、送信者ごとのセッションを作成します。
