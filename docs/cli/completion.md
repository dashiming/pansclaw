...
read_when:
  ...
  - You need to cache completion scripts under PansClaw state
title: "completion"
---
...
- `--install` writes a small "PansClaw Completion" block into your shell profile and points it at the cached script.
