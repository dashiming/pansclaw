...
read_when:
  - Setting up Twitch chat integration for PansClaw
title: "Twitch"
---

# Twitch (plugin)

Twitch chat support via IRC connection. PansClaw connects as a Twitch user (bot account) to receive and send messages in channels.
