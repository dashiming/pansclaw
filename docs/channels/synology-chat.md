---
summary: "Synology Chat webhook setup and PansClaw config"
read_when:
  - Setting up Synology Chat with PansClaw
...
3. Point the outgoing webhook URL to your PansClaw gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in PansClaw.
...
```bash
openclaw message send --channel synology-chat --target 123456 --text "Hello from PansClaw"
