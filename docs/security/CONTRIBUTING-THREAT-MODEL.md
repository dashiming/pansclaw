# Contributing to the PansClaw Threat Model

Thanks for helping make PansClaw more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.
...
- Which parts of PansClaw are affected (CLI, gateway, channels, ClawHub, MCP servers, etc.)
...
- [PansClaw Threat Model](/security/THREAT-MODEL-ATLAS)
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the PansClaw security hall of fame for significant contributions.
