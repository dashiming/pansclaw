---
summary: "Shared Docker VM runtime steps for long-lived PansClaw Gateway hosts"
read_when:
  - You are deploying PansClaw on a cloud VM with Docker
...
PansClaw runs in Docker, but Docker is not the source of truth.
