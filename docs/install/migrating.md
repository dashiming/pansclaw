---
summary: "Move (migrate) a PansClaw install from one machine to another"
read_when:
  - You are moving PansClaw to a new laptop/server
  - You want to preserve sessions, auth, and channel logins (WhatsApp, etc.)
title: "Migration Guide"
---

# Migrating PansClaw to a new machine

This guide migrates a PansClaw Gateway from one machine to another **without redoing onboarding**.
...
### Step 1 — Install PansClaw on the new machine
...
- [Where does PansClaw store its data?](/help/faq#where-does-openclaw-store-its-data)
