---
summary: "Run PansClaw Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want PansClaw running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running PansClaw in Docker on Hetzner or a similar provider
title: "Hetzner"
---

# PansClaw on Hetzner (Docker, Production VPS Guide)

## Goal

Run a persistent PansClaw Gateway on a Hetzner VPS using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want “PansClaw 24/7 for ~$5”, this is the simplest reliable setup.
...
## 3) Clone the PansClaw repository
