...
PansClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, PansClaw also aligns
the install method:
...
When you switch channels with `openclaw update`, PansClaw also syncs plugin sources:
