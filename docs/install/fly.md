---
title: Fly.io
description: Deploy PansClaw on Fly.io
summary: "Step-by-step Fly.io deployment for PansClaw with persistent storage and HTTPS"
read_when:
  - Deploying PansClaw on Fly.io
  - Setting up Fly volumes, secrets, and first-run config
---

# Fly.io Deployment

**Goal:** PansClaw Gateway running on a [Fly.io](https://fly.io) machine with persistent storage, automatic HTTPS, and Discord/channel access.
