...
PansClaw ships three installer scripts, served from `openclaw.ai`.

| Script                             | Platform             | What it does                                                                                 |
| ---------------------------------- | -------------------- | -------------------------------------------------------------------------------------------- |
| [`install.sh`](#installsh)         | macOS / Linux / WSL  | Installs Node if needed, installs PansClaw via npm (default) or git, and can run onboarding. |
| [`install-cli.sh`](#install-clish) | macOS / Linux / WSL  | Installs Node + PansClaw into a local prefix (`~/.openclaw`). No root required.              |
| [`install.ps1`](#installps1)       | Windows (PowerShell) | Installs Node if needed, installs PansClaw via npm (default) or git, and can run onboarding. |
...
<Steps>
  ...
  <Step title="Ensure Node.js 24 by default">
    Checks Node version and installs Node 24 if needed (Homebrew on macOS, NodeSource setup scripts on Linux apt/dnf/yum). PansClaw still supports Node 22 LTS, currently `22.16+`, for compatibility.
  </Step>
  <Step title="Ensure Git">
    Installs Git if missing.
  </Step>
  <Step title="Install PansClaw">
...
If run inside an PansClaw checkout (`package.json` + `pnpm-workspace.yaml`), the script offers:
...
<Steps>
  ...
  <Step title="Install PansClaw under prefix">
...
| `--version <ver>`      | PansClaw version or dist-tag (default: `latest`)                                |
...
| `OPENCLAW_VERSION=<ver>`                    | PansClaw version or dist-tag                                                      |
