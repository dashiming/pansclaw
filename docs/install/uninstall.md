---
summary: "Uninstall PansClaw completely (CLI, service, state, workspace)"
read_when:
  - You want to remove PansClaw from a machine
...
```bash
rm -rf /Applications/PansClaw.app
```
...
Default task name is `PansClaw Gateway` (or `PansClaw Gateway (<profile>)`).
The task script lives under your state dir.

```powershell
schtasks /Delete /F /TN "PansClaw Gateway"
