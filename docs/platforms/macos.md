---
summary: "PansClaw macOS companion app (menu bar + gateway broker)"
read_when:
...
# PansClaw macOS Companion (menu bar + gateway broker)

The macOS app is the **menu‑bar companion** for PansClaw. It owns permissions,
...
1. Install and launch **PansClaw.app**.
...
Avoid putting your PansClaw state dir in iCloud or other cloud-synced folders.
