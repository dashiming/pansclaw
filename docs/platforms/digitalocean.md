---
summary: "PansClaw on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up PansClaw on DigitalOcean
  - Looking for cheap VPS hosting for PansClaw
title: "DigitalOcean"
---

# PansClaw on DigitalOcean

## Goal

Run a persistent PansClaw Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
