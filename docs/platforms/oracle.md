---
summary: "PansClaw on Oracle Cloud (Always Free ARM)"
read_when:
  - Setting up PansClaw on Oracle Cloud
  - Looking for low-cost VPS hosting for PansClaw
  - Want 24/7 PansClaw on a small server
title: "Oracle Cloud"
---

# PansClaw on Oracle Cloud (OCI)

## Goal

Run a persistent PansClaw Gateway on Oracle Cloud's **Always Free** ARM tier.

Oracle’s free tier can be a great fit for PansClaw (especially if you already have an OCI account), but it comes with tradeoffs:
