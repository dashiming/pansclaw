---
summary: "macOS IPC architecture for PansClaw app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# PansClaw macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → PansClaw.app → local execution.
