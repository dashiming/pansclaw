...
This guide summarizes a sane workflow for working on the pi integration in PansClaw.
...
State lives under the PansClaw state directory. Default is `~/.openclaw`. If `OPENCLAW_STATE_DIR` is set, use that directory instead.
