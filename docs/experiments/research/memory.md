...
read_when:
  ...
  - Deciding: standalone CLI vs deep PansClaw integration
...
Recommendation: **deep integration in PansClaw**, but keep a separable core library.

### Why integrate into PansClaw?

- PansClaw already knows:
