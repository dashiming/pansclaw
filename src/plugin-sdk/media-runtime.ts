...
// Keep this API available without introducing a static import cycle.
export async function transcribeFirstAudio(
  params: Parameters<
    typeof import("../media-understanding/audio-preflight.js").transcribeFirstAudio
  >[0],
) {
  const mod = await import("../media-understanding/audio-preflight.js");
  return await mod.transcribeFirstAudio(params);
}
