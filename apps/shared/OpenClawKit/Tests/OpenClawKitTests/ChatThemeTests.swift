...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = PansClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = PansClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
