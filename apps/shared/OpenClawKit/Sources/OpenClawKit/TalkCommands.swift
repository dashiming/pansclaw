...
public enum PansClawTalkCommand: String, Codable, Sendable {
...
public struct PansClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct PansClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
