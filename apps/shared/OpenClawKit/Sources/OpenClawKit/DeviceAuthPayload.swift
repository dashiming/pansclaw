...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: PansClawProtocol.AnyCodable]?
    {
        ...
        return [
            "id": PansClawProtocol.AnyCodable(identity.deviceId),
            "publicKey": PansClawProtocol.AnyCodable(publicKey),
            "signature": PansClawProtocol.AnyCodable(signature),
            "signedAt": PansClawProtocol.AnyCodable(signedAtMs),
            "nonce": PansClawProtocol.AnyCodable(nonce),
        ]
    }
}
