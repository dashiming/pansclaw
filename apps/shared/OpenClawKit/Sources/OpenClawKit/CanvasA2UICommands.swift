...
public enum PansClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct PansClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct PansClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
