...
public struct PansClawChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct PansClawChatSessionsDefaults: Codable, Sendable {
...
public struct PansClawChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct PansClawChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: PansClawChatSessionsDefaults?
    public let sessions: [PansClawChatSessionEntry]
    ...
    public init(
        ...
        sessions: [PansClawChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
