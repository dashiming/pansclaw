...
public typealias PansClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias PansClawPlatformImage = UIImage
#endif

public struct PansClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct PansClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: PansClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(PansClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct PansClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct PansClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [PansClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: PansClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [PansClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: PansClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(PansClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([PansClawChatMessageContent].self, forKey: .content) {
...
public struct PansClawChatHistoryPayload: Codable, Sendable {
...
public struct PansClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct PansClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [PansClawSessionPreviewItem]
}

public struct PansClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [PansClawSessionPreviewEntry]

    public init(ts: Int, previews: [PansClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct PansClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct PansClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct PansClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct PansClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct PansClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct PansClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: PansClawPlatformImage?
...
public struct PansClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
