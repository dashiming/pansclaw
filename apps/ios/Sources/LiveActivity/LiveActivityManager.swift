...
final class LiveActivityManager {
    ...
    private var currentActivity: Activity<PansClawActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = PansClawActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<PansClawActivityAttributes>.activities
    ...
    private func updateCurrent(state: PansClawActivityAttributes.ContentState) {
    ...
    private func connectingState() -> PansClawActivityAttributes.ContentState {
        PansClawActivityAttributes.ContentState(
    ...
    private func idleState() -> PansClawActivityAttributes.ContentState {
        PansClawActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> PansClawActivityAttributes.ContentState {
        PansClawActivityAttributes.ContentState(
