...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: PansClawPhotosLatestParams) async throws -> PansClawPhotosLatestPayload {
        ...
        var results: [PansClawPhotoPayload] = []
        ...
        return PansClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> PansClawPhotoPayload
    {
