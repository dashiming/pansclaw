...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [PansClawCapability.canvas.rawValue, PansClawCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(PansClawCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(PansClawCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = PansClawLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(PansClawCapability.location.rawValue) }

        caps.append(PansClawCapability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(PansClawCapability.watch.rawValue)
        }
        caps.append(PansClawCapability.photos.rawValue)
        caps.append(PansClawCapability.contacts.rawValue)
        caps.append(PansClawCapability.calendar.rawValue)
        caps.append(PansClawCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(PansClawCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            PansClawScreenCommand.record.rawValue,
            PansClawSystemCommand.notify.rawValue,
            PansClawChatCommand.push.rawValue,
        ...
        if caps.contains(PansClawCapability.camera.rawValue) {
            commands.append(PansClawCameraCommand.list.rawValue)
            commands.append(PansClawCameraCommand.snap.rawValue)
            commands.append(PansClawCameraCommand.clip.rawValue)
        }
        if caps.contains(PansClawCapability.location.rawValue) {
            commands.append(PansClawLocationCommand.get.rawValue)
        }
        if caps.contains(PansClawCapability.device.rawValue) {
            commands.append(PansClawDeviceCommand.status.rawValue)
            commands.append(PansClawDeviceCommand.info.rawValue)
        }
        if caps.contains(PansClawCapability.watch.rawValue) {
            commands.append(PansClawWatchCommand.status.rawValue)
            commands.append(PansClawWatchCommand.notify.rawValue)
        }
        if caps.contains(PansClawCapability.photos.rawValue) {
            commands.append(PansClawPhotosCommand.latest.rawValue)
        }
        if caps.contains(PansClawCapability.contacts.rawValue) {
            commands.append(PansClawContactsCommand.search.rawValue)
            commands.append(PansClawContactsCommand.add.rawValue)
        }
        if caps.contains(PansClawCapability.calendar.rawValue) {
            commands.append(PansClawCalendarCommand.events.rawValue)
            commands.append(PansClawCalendarCommand.add.rawValue)
        }
        if caps.contains(PansClawCapability.reminders.rawValue) {
            commands.append(PansClawRemindersCommand.list.rawValue)
            commands.append(PansClawRemindersCommand.add.rawValue)
        }
        if caps.contains(PansClawCapability.motion.rawValue) {
            commands.append(PansClawMotionCommand.activity.rawValue)
            commands.append(PansClawMotionCommand.pedometer.rawValue)
        }
