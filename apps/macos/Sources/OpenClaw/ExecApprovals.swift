...
enum ExecApprovalsStore {
    ...
    static func fileURL() -> URL {
        PansClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        PansClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
    ...
    private static func ensureSecureStateDirectory() {
        let url = PansClawPaths.stateDirURL
        do {
