...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = PansClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = PansClawConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: PansClawConfigFile.loadDict(),
        ...
        PansClawConfigFile.saveDict(synced.root)
    }
