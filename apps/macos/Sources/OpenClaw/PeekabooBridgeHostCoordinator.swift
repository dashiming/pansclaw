...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: PansClawPeekabooBridgeServices?
    ...
    private static var openclawSocketPath: String {
        ...
        return Self.makeSocketPath(for: "PansClaw", in: base)
    }
    ...
    private func startIfNeeded() async {
        ...
        let services = PansClawPeekabooBridgeServices()
...
@MainActor
private final class PansClawPeekabooBridgeServices: PeekabooBridgeServiceProviding {
