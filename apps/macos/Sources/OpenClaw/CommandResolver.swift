...
enum CommandResolver {
    ...
    static func projectPansClawExecutable(projectRoot: URL? = nil) -> String? {
        #if DEBUG
    ...
    static func hasAnyPansClawInvoker(searchPaths: [String]? = nil) -> Bool {
        ...
        searchPaths: [String]? = nil) -> [String]
    {
        ...
        let root = self.projectRoot()
        if let openclawPath = self.projectPansClawExecutable(projectRoot: root) {
    ...
    {
        let root = configRoot ?? PansClawConfigFile.loadDict()
